...
<template>
    ...
    <AppLayout>
        <div class="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div class="bg-white dark:bg-slate-900/50 backdrop-blur-md p-3 md:p-2.5 rounded-3xl md:rounded-md border border-slate-200 dark:border-white/5 shadow-sm">
            ...
            <!-- Transactions Area -->
            <div class="bg-white dark:bg-slate-900/40 backdrop-blur-md rounded-3xl md:rounded-md border border-slate-200 dark:border-white/5 shadow-sm overflow-hidden">
                <!-- Desktop Table -->
