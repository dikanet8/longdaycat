        ...
        <div class="space-y-6 print:hidden">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-4">
                    <div class="bg-white dark:bg-slate-900/40 backdrop-blur-md p-4 rounded-xl border border-slate-200 dark:border-white/5 shadow-sm flex items-center gap-4">
                    ...
                    <div class="bg-white dark:bg-slate-900/40 backdrop-blur-md rounded-xl border border-slate-200 dark:border-white/5 shadow-sm overflow-hidden">
                ...
                <div class="space-y-6 lg:sticky lg:top-6 h-fit">
                    <!-- Print Settings Card -->
                    <div class="bg-white dark:bg-slate-900/40 backdrop-blur-md rounded-xl border border-slate-200 dark:border-white/5 shadow-sm p-5">
                    ...
                    <!-- Print Queue Card -->
                    <div class="bg-white dark:bg-slate-900/40 backdrop-blur-md rounded-xl border border-slate-200 dark:border-white/5 shadow-sm p-5 flex flex-col">
                    ...
                    <div v-if="printList.length > 0" class="bg-white dark:bg-slate-900/40 backdrop-blur-md rounded-xl border border-slate-200 dark:border-white/5 p-5 shadow-sm">
