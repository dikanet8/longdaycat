    ...
    <div class="max-w-3xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div class="space-y-1">
        <div class="flex items-center gap-3">
          ...
          <h1 class="text-2xl md:text-3xl font-black text-slate-900 dark:text-white tracking-tight">Edit Pengguna</h1>
        </div>
        <p class="text-slate-500 dark:text-slate-400 font-medium text-sm ml-[52px]">Perbarui informasi akun untuk {{ user.name }}.</p>
      </div>

      <!-- Form Card -->
      <div class="bg-white dark:bg-slate-900 rounded-md border border-slate-200 dark:border-white/5 overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-2">
                ...
                <input 
                  v-model="form.name" 
                  type="text" 
                  class="w-full bg-slate-50 dark:bg-white/5 border-none rounded-md text-sm focus:ring-2 focus:ring-blue-500 dark:text-white p-3 md:p-4 transition-all" 
                  required 
                />
              </div>
              ...
              <div class="space-y-2">
                ...
                <select 
                  v-model="form.role" 
                  class="w-full bg-slate-50 dark:bg-white/5 border-none rounded-md text-sm focus:ring-2 focus:ring-blue-500 dark:text-white p-3 md:p-4 transition-all appearance-none"
                >
